      ...
      <q-card-section>
        <q-form @submit.prevent="handleSubmit">
          <div v-if="transactionValue">
            ...
            <q-input filled v-model.number="testTransaction.amount" type="number" required label="Income Amount" />
          </div>
          ...
          <div v-else>
            ...
            <q-input filled v-model.number="testTransaction.amount" type="number" required label="Expense Amount" />
          </div>
          ...
          <q-select class="q-my-md" filled v-model="testTransaction.tags" :options="transactionsTags" option-value="id"
            option-label="name" multiple use-chips map-options>
